...
glm.fits=glm(Classi~CT+CellSize+CellShape+MA+SE_CellSize+BN+BC+NN+Mitoses,data=data,family=binomial)
...
Classi=ifelse(Class==2,"0","1")
data=data.frame(data,Classi)
bag.fit=randomForest(Classi~CT+CellSize+CellShape+MA+SE_CellSize+BN+BC+NN+Mitoses,data=data,mtry=10)
